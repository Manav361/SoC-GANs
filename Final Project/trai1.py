...
from utils import gradient_penalty, save_checkpoint, plot_examples
...
def train_fn(
    ...
    for idx, (low_res, high_res) in enumerate(loop):
        ...
        if idx % 100 == 0 and idx > 0:
            plot_examples("div2k\DIV2K_valid_HR", gen)
...
def main():
    dataset = MyImageFolder(root_dir="div2k\\DIV2K_train_HR")
    loader = DataLoader(
        dataset,
    ...
    # No need to save checkpoints since you don't want to save them
    save_model(gen, "Ckpt\gen.pth")
    save_model(disc, "Ckpt\disc.pth")
